        ...
        <div className="flex-1 w-full">
          ...
          >
            ...
            <div className="flex items-center gap-6 sm:gap-8 mb-12">
              ...
              <div className="w-32 h-32 sm:w-40 sm:h-40 rounded-full bg-white/5 border border-white/10 flex items-center justify-center shadow-[0_0_20px_rgba(86,132,209,0.15)] backdrop-blur-sm group cursor-pointer transition-all hover:bg-white/10 hover:shadow-[0_0_30px_rgba(86,132,209,0.25)]">
                <div
                  className="w-20 h-20 sm:w-24 sm:h-24 transition-colors duration-300 bg-white/80 group-hover:bg-[#5684D1]"
                  style={{
            ...
            <div className="relative rounded-xl overflow-hidden bg-[#0F172A] border border-[var(--border-subtle)] shadow-2xl">
              ...
              <div className="p-6 font-mono text-sm sm:text-base leading-loose overflow-x-auto text-white/80">
                <pre><code>
                  ...
                  {'      '}<span className="text-[#98C379]">"GET /get_route"</span><span className="text-white/60">: {'{'}</span>{'\n'}
                  ...
                  {'        '}<span className="text-[#E5C07B]">description</span><span className="text-white/60">:</span> <span className="text-[#98C379]">"Get route"</span><span className="text-white/60">,</span>    <span className="text-[#5C6370] italic">{'//'} What your endpoint does</span>{'\n'}
