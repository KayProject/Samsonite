    ...
    <Sonner
      ...
      toastOptions={{
        ...
        classNames: {
          ...
          info: "group-[.toaster]:border-l-[#F59E0B] group-[.toast]:text-[#F59E0B]",

          // Colorize the built-in SVG icons to match the status
          icon: "group-data-[type=error]:text-[#EF4444] group-data-[type=success]:text-[#22C55E] group-data-[type=warning]:text-[#F59E0B] group-data-[type=info]:text-[#F59E0B]",
        },
      }}
      {...props}
    />
